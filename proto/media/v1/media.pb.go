...
const file_proto_media_v1_media_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/media/v1/media.proto\x12\bmedia.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"^\n" +
	"\rUploadRequest\x12*\n" +
	...
	"\bmedia_id\x18\x01 \x01(\tR\amediaId\"p\n" +
	"\x17ListMediaByOwnerRequest\x12\x19\n" +
	...
	"\x15DownloadStreamRequest\x12\x19\n" +
	"\bmedia_id\x18\x01 \x01(\tR\amediaId\x12\x18\n" +
	...
	"\adeleted\x18\x01 \x01(\bR\adeleted\"1\n" +
	"\x14DeleteByOwnerRequest\x12\x19\n" +
	...
	"\rDeleteByOwner\x12\x1e.media.v1.DeleteByOwnerRequest\x1a\x1f.media.v1.DeleteByOwnerResponseB%Z#mediaservice/proto/media/v1;mediav1b\x06proto3"
